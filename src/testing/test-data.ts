...
export const getUser = delayFn(() => testData.users[0], 0);

export const getOrganization = delayFn(
  (id: string) => testData.organizations.find((o) => o.id === id, id) || null,
  300
);

export const getJobs = delayFn(
...
export const useOrganization = (id: string) => useTestData(getOrganization(id));
